...
exports.openAnimationEditor = openAnimationEditor;
 ...
 */
function openAnimationEditor(context, component, omosceneEditor, inspectorProvider) {
    if (activePanel) {
        activePanel.reveal(vscode.ViewColumn.One);
        loadComponentIntoPanel(activePanel, component, omosceneEditor);
        return;
    }
    activePanel = vscode.window.createWebviewPanel('omosuen.animationEditor', `Animations: ${component.name}`, vscode.ViewColumn.One, {
        enableScripts: true,
    ...
    activePanel.webview.onDidReceiveMessage((msg) => {
        if (msg.type === 'ready') {
            ...
            omosceneEditor.updateComponentProperty(component.id, 'animations', msg.animations);
            component.animations = msg.animations;
...
// ── Webview HTML ──────────────────────────────────────────────────
function getAnimationEditorHtml() {
...
//# sourceMappingURL=animation-editor.js.map