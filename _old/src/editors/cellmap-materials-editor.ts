 ...
 */
export function openCellMapMaterialsEditor(
  ...
  activePanel.webview.onDidReceiveMessage(
    (msg: { type: string; materials?: CellMapMaterial[] }) => {
      if (msg.type === 'ready') {
        loadComponentIntoPanel(activePanel!, component, omosceneEditor);
        ...
        (component as Record<string, unknown>).materials = msg.materials;
...
function loadComponentIntoPanel(
  ...
  const availableTextureMaps: AvailableTextureMap[] = [];
...
function getMaterialsEditorHtml(): string {
