/**
 * Pure reducer for the texture-frame tool (5a).
 * Operates on texture-map `imageType` — DOM-free / Electron-free.
 */
...
/** Serialize editor state to on-disk `imageType` (null = single). */
